...
namespace DBSupport
{
	...
	internal class Odbc : IDataAccess
	{
		...
		#region 创建OdbcCommand对象并配置其参数列表(私有方法)

		/// <summary>
		/// 创建OdbcCommand对象并配置其参数列表
		/// </summary>
		/// <param name="IsProceduceType">命令对象类型标志</param>
		/// <param name="commandText">命令文本</param>
		/// <param name="Params">参数列表</param>
		/// <returns>配置后的OdbcCommand对象</returns>
        ...
        #region 执行查询方法返回OdbcDataReader对象

        /// <summary>
        /// 执行无参查询SQL返回OdbcDataReader对象，失败返回null
		/// </summary>
		/// <param name="commandText">无参查询SQL语句</param>
        /// <returns>OdbcDataReader对象，失败返回null</returns>
		...
		/// <summary>
        /// 执行带参查询SQL语句返回OdbcDataReader对象，失败返回null
		/// </summary>
		...
		/// <summary>
        /// 执行无参查询存储过程返回OdbcDataReader对象，失败返回null
		/// </summary>
		...
		/// <summary>
        /// 执行有参查询存储过程返回OdbcDataReader对象，失败返回null
		/// </summary>
		/// <param name="strProcduceName">存储过程名</param>
		/// <param name="Params">参数列表</param>
        /// <returns>OdbcDataReader对象，失败返回null</returns>
